...
const addCalculatorStyles = () => {
    ...
    style.textContent = `
        ...
        .history-item-value strong, .history-item-result strong {
            font-size: 1rem;
        }
        ...
        .dark-mode .result-detail-item span {
            color: var(--text-muted);
        }
        
        .dark-mode .result-detail-item strong {
            color: var(--text-light);
        }
        
        .dark-mode .calculator-history {
            background: var(--bg-secondary);
        }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        window.precatorioCalculator = new PrecatorioCalculator();
        console.log('Calculadora de Precatórios inicializada com sucesso!');
    } catch (error) {
